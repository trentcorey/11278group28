...
class YOLO(object):
    _defaults = {
        "model_path": 'logs/yolov3_weights.h5',
    ...
    def _get_class(self):
        ...
        self.classes_path = os.path.join(script_dir, self.classes_path)
    ...
    def _get_anchors(self):
        script_dir = os.path.dirname(__file__)
        self.anchors_path = os.path.join(script_dir, self.anchors_path)
